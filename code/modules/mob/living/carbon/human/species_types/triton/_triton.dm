...
/datum/species/triton
	...
	specstats_m = list(STATKEY_STR = 0, STATKEY_PER = 0, STATKEY_CON = 0, STATKEY_SPD = 1, STATKEY_INT = 2)
	specstats_f = list(STATKEY_STR = 0, STATKEY_PER = 0, STATKEY_CON = 0, STATKEY_SPD = 1, STATKEY_INT = 2)
